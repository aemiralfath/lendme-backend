...
// GetLoans provides a mock function with given fields: ctx, debtorID, name, status, _a4
func (_m *Repository) GetLoans(ctx context.Context, debtorID string, name string, status []int, _a4 *pagination.Pagination) (*pagination.Pagination, error) {
	ret := _m.Called(ctx, debtorID, name, status, _a4)

	var r0 *pagination.Pagination
	if rf, ok := ret.Get(0).(func(context.Context, string, string, []int, *pagination.Pagination) *pagination.Pagination); ok {
		r0 = rf(ctx, debtorID, name, status, _a4)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, string, string, []int, *pagination.Pagination) error); ok {
		r1 = rf(ctx, debtorID, name, status, _a4)
	} else {
		r1 = ret.Error(1)
	}
...
// GetPayments provides a mock function with given fields: ctx, debtorID, name, _a3
func (_m *Repository) GetPayments(ctx context.Context, debtorID string, name string, _a3 *pagination.Pagination) (*pagination.Pagination, error) {
	ret := _m.Called(ctx, debtorID, name, _a3)

	var r0 *pagination.Pagination
	if rf, ok := ret.Get(0).(func(context.Context, string, string, *pagination.Pagination) *pagination.Pagination); ok {
		r0 = rf(ctx, debtorID, name, _a3)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pagination.Pagination)
		}
...
func (_m *Repository) GetVouchers(ctx context.Context, name string, _a2 *pagination.Pagination) (*pagination.Pagination, error) {
