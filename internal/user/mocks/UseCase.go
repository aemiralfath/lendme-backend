...
// GetLoans provides a mock function with given fields: ctx, userID, name, status, _a4
func (_m *UseCase) GetLoans(ctx context.Context, userID string, name string, status []int, _a4 *pagination.Pagination) (*pagination.Pagination, error) {
	ret := _m.Called(ctx, userID, name, status, _a4)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, []int, *pagination.Pagination) *pagination.Pagination); ok {
		r0 = rf(ctx, userID, name, status, _a4)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, []int, *pagination.Pagination) error); ok {
		r1 = rf(ctx, userID, name, status, _a4)
	} else {
		r1 = ret.Error(1)
	}
...
// GetPayments provides a mock function with given fields: ctx, userID, name, _a3
func (_m *UseCase) GetPayments(ctx context.Context, userID string, name string, _a3 *pagination.Pagination) (*pagination.Pagination, error) {
