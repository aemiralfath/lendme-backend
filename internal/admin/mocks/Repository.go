...
func (_m *Repository) GetDebtors(ctx context.Context, name string, _a2 *pagination.Pagination) (*pagination.Pagination, error) {
...
func (_m *Repository) GetLoans(ctx context.Context, name string, status []int, _a3 *pagination.Pagination) (*pagination.Pagination, error) {
...
func (_m *Repository) GetPayments(ctx context.Context, name string, _a2 *pagination.Pagination) (*pagination.Pagination, error) {
	ret := _m.Called(ctx, name, _a2)
